"""
Experimental demo showing the quality-flywheel APIs in action.
...
def _raise_for_iteration_errors(results: dict, iteration: int) -> None:
    """Prevent the demo from reporting completion after an optimization failure."""
    optimization = results.get("optimization", {})
    if "error" in optimization:
        raise RuntimeError(
            f"Flywheel iteration {iteration} optimization failed: "
...
async def main():
    """Run the experimental quality flywheel demonstration."""
    print("=" * 70)
    print("  CODING AGENT QUALITY FLYWHEEL - EXPERIMENTAL DEMONSTRATION")
    print("=" * 70)
    ...
    _raise_for_iteration_errors(results_1, 1)
    print(f"\n    Iteration 1 results:")
...
Always test your code and fix any issues before submitting.""",
    ...
    _raise_for_iteration_errors(results_2, 2)
    print(f"\n    Iteration 2 results:")
    ...
    print("\n" + "=" * 70)
    print("  EXPERIMENTAL DEMONSTRATION COMPLETE")
    print("=" * 70)
    print("""
